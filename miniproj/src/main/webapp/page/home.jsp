...
<body>
	...
	<div class="container my-5">
		<div id="hero-section" style="border: 1px solid #a75d00">
			...
			<div class="mt-4" style="display: flex; gap: 50px; justify-content: center;">
				<a href="/miniproj/page/matching/matchQuiz.jsp" class="btn text-black" id="border-btn">운명의 동물 퀴즈</a> 
				<a href="#" class="btn" id="main-btn">운명의 동물 보기</a>
			</div>
		</div>
	</div>
	<!-- 유기동물 리스트 영역 -->
			...
			<div class="col-md-4">
				<div class="card shadow-sm">
					...
					<div class="card-body">
						...
						<a href="#" class="btn" id="main-btn" style="display: block">커뮤니티 참여하기</a>
					</div>
				</div>
			</div>
			<div class="col-md-4">
