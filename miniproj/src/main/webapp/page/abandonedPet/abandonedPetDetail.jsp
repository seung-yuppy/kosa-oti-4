		...
		<div class="card shadow-sm">
			<div class="card-body">
					...
					<div class="row">
						<div class="col-md-6 mb-2">
							<div class="check-item">
								<img src="/miniproj/image/ico_success.png" class="card-icon" />
								예방 접종 완료
							</div>
						</div>
						<div class="col-md-6 mb-2">
							<div class="fail-item">
								<img src="/miniproj/image/ico_fail.png" class="card-icon" />
								기본 건강 검진 완료
							</div>
						</div>
						<div class="col-md-6 mb-2">
				...
				<div class="mb-4 contact-info">
					...
					<p>
						<img src="/miniproj/image/ico_calendar.png" class="card-icon" />
						2024년 5월 15일
					</p>

					<p class="fw-bold mt-4">입양 문의</p>
					<p>
						<img src="/miniproj/image/ico_homelocation.png" class="card-icon" />
						생명 존중 동물 보호소
					</p>
					<p>
						<img src="/miniproj/image/ico_tel.png" class="card-icon" />
						02-1234-5678
					</p>
				</div>
