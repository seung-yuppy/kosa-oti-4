...
<!-- ====== Community Toolbar — START ====== -->
	<div class="container">
		...
		<article class="card">
			<header class="card-head">
				<div class="author">
					...
					<div>
						<div class="who">
							<span class="name">김하나</span> <span class="badge">일반회원</span>
						</div>
			...
			<div class="thumb"
				style="background-image: url('https://images.unsplash.com/photo-1534361960057-19889db9621e?q=80&amp;w=1200&amp;auto=format&amp;fit=crop');"></div>

			<div class="content">요즘 날씨가 너무 좋아서 강아지 산책하기 딱 좋은데요! 산책할 때 꼭 챙겨야
				할 준비물과 주의할 점들을 공유합니다. 배변 봉투, 물, 그리고 목줄은 필수겠죠? 혹시 놓치기 쉬운 점이 있을까요?</div>
		...
		<nav class="pagination" aria-label="페이지">
			<span class="page-nav"> <svg width="18" height="18"
					viewBox="0 0 24 24" fill="none" stroke="currentColor"
					stroke-width="2">
					<path d="M15 18 9 12l6-6" /></svg> Previous
			</span> <span class="page page--current">1</span> <a class="page" href="#">2</a>
			<a class="page" href="#">3</a> <a class="page" href="#">4</a> <a
				class="page" href="#">5</a> <span class="page-nav"> Next <svg
